...
public class ClientMain implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ScreenRegistry.<BeehiveOvenGuiDescription, BeehiveOvenGuiScreen>register(ModMain.BEEHIVE_OVEN_SCREEN_HANDLER_TYPE, (gui, inventory, title) -> new BeehiveOvenGuiScreen(gui, inventory.player, title));
